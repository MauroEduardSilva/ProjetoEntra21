...
public class Conquista {
	...
	//nome conquista;  descricao conquista; icone conquista
	...
	public void setDescricaoConquista(String descicaoConquista) {
		this.descricaoConquista = descricaoConquista;
	}
	
	public String getIconeConquista() {
		return iconeConquista;
	}
	public void setIconeConquista(String iconeConquista) {
		this.iconeConquista = iconeConquista;
	}
}
